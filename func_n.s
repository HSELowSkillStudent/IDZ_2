...
countSignes:
	...
	mov	rbp, rsp                                # пролог
							...
							# сохраняю регистры для дальнешего использования
	...
	# mov	QWORD PTR -24[rbp], rdi                 # const char *input - локальная переменная
	
	# mov	QWORD PTR -8[rbp], 0                    # size_t i = 0 - локальная переменная	
